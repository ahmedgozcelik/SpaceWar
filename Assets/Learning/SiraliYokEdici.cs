...
//            position.z = -Camera.main.transform.position.z; // Z ekseni kameraya göre ayarladndı.
//            position = Camera.main.ScreenToWorldPoint(position); // Pozisyon oyun ekranının koordinatlarına çevrildi.
...
//    {
//        return Vector3.Distance(uzayGemisi.transform.position, hedef.transform.position); // Hedef ile uzay gemisi arasındaki mesafeyi return eder.
//    }
